...
import fr.lohier.objets.TuyauRouge;
import fr.lohier.personnages.Champ;
import fr.lohier.personnages.Mario;
import fr.lohier.personnages.Tortue;
...
public class Scene extends JPanel{
	...
	public Scene(){		
		...
		this.police = new Font("Arial", Font.PLAIN, 18);
